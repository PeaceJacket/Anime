                    ...
                    <div class="trending__product">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4">
                                <div class="btn__all">
                                    <a href="/admin-list-anime" class="primary-btn">Ver todo <span class="arrow_right"></span></a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="poster_anime/{{$anime_individual->imagen}}">
                                        <div class="ep" style="display:none">18 / 18</div>
                                        <div class="comment" style="display:none"><i class="fa fa-comments"></i> 11</div>
                                        <div class="view" style="display:none"><i class="fa fa-eye"></i> 9141</div>
                                    </div>
                                    <div class="product__item__text">
                                        ...
                                        <h5><a href="#">{{$anime_individual->titulo}}</a></h5>
                                    </div>
                                </div>
                            </div>
                            @endforeach
